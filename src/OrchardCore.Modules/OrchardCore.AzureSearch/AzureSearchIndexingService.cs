...
{
    /// <summary>
    /// This class provides services to update all the AzureSearch indices. It is non-rentrant so that calls 
    ...
    /// </summary>
    public class AzureSearchIndexingService
    {
        private const int BatchSize = 100;
        private readonly IShellHost _shellHost;
        private readonly ShellSettings _shellSettings;
        private readonly AzureSearchIndexingState _indexingState;
        ...
        public AzureSearchIndexingService(
            ...
            AzureSearchIndexingState indexingState,
            AzureSearchIndexManager indexManager,
        ...
        public async Task<AzureSearchSettings> GetAzureSearchSettingsAsync()
        {
            ...
            if (siteSettings.Has<AzureSearchSettings>())
            {
                return siteSettings.As<AzureSearchSettings>();
            }
