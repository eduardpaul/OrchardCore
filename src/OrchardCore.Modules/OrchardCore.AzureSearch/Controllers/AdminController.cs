...
namespace OrchardCore.AzureSearch.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //viewModel.Indexes = _AzureSearchIndexManager.List().Select(s => new IndexViewModel { Name = s }).ToArray();
        ...
        public async Task<ActionResult> CreatePOST(AdminEditViewModel model)
        {
            ...
            ValidateModel(model);
            /*
            if (_AzureSearchIndexManager.Exists(model.IndexName))
            {
            ...
            */
            ...
            try
            {
                ...
                _AzureSearchIndexingService.RebuildIndex(model.IndexName);
                await _AzureSearchIndexingService.ProcessContentItemsAsync();
            }
            catch (Exception e)
            {
        ...
        public async Task<ActionResult> Reset(string id)
        {
            ...
            /*
            if (!_AzureSearchIndexManager.Exists(id))
            {
                return NotFound();
            }
            */

            _AzureSearchIndexingService.ResetIndex(id);
            await _AzureSearchIndexingService.ProcessContentItemsAsync();
        ...
        public async Task<ActionResult> Rebuild(string id)
        {
            ...
            */
            _AzureSearchIndexingService.RebuildIndex(id);
            await _AzureSearchIndexingService.ProcessContentItemsAsync();
        ...
        public async Task<ActionResult> Delete(AdminEditViewModel model)
        {
            ...
            */
            try
            {
                //_AzureSearchIndexManager.DeleteIndex(model.IndexName);
        ...
        public async Task<IActionResult> Query(AdminQueryViewModel model)
        {
            ...
            */
            ...
            stopwatch.Start();
            /*
            await _AzureSearchIndexManager.SearchAsync(model.IndexName, async searcher =>
            {
