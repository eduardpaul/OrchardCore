...
using OrchardCore.AzureSearch;

namespace OrchardCore.Queries.AzureSearch.GraphQL.Queries
{
    public class AzureSearchQueryFieldTypeProvider : ISchemaBuilder
    {
        private readonly IHttpContextAccessor _httpContextAccessor;

        public AzureSearchQueryFieldTypeProvider(IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IChangeToken> BuildAsync(ISchema schema)
        {
            ...
            foreach (var query in queries.OfType<AzureSearchQuery>())
            {
        ...
        private FieldType BuildSchemaBasedFieldType(AzureSearchQuery query, JToken schema)
        {
        ...
        private FieldType BuildContentTypeFieldType(ISchema schema, string contentType, AzureSearchQuery query)
        {
